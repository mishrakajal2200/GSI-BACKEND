...
// import harissonsRoutes from './routes/harissonsRoutes.js';
...
// const app = express();
// // Enable CORS
// const allowedOrigins = [ 'http://localhost:3001']; // Add any other domains you need
// const corsOptions = {
...
// app.use('/api/harissonsproducts',harissonsRoutes);
// app.use('/api/cosmosproduct',cosmosRoutes);
...
//   } finally {
//     // Close the database connection after the script is finished
